...
import { IconBrain, IconInfoCircle, IconMoon, IconPalette, IconSun, TablerIconsProps } from "@tabler/icons-react";
...
export default function Settings({ style }: {style?: CSSProperties})
{
    ...
    const [hide, set_hide] = useStorage("hide-ambiguous", true);
    ...
    return <Stack m="lg" style={style}>
        ...
        <Option Control={Switch} option-label="Hide Ambiguous" checked={hide} onChange={e => set_hide(e.currentTarget.checked)} no-fixed />
